...
/**
 * Class from: https://github.com/eugenp/tutorials/blob/master/core-java-modules/core-java-arrays/src/main/java/com/baeldung/array/MultiDimensionalArray.java
 */
public class MultiDimensionalArray {
    ...
    void initializeElements(int[][] multiDimensionalArray) {
        ...
        for (int outer = 0; outer < multiDimensionalArray.length; outer++) {
            int inner = 0;
            while (inner < multiDimensionalArray[outer].length) {
    ...
    int[][] copy2DArray(int[][] arrayOfArrays) {
        ...
        IntStream.range(0, arrayOfArrays.length).forEach(i -> {
